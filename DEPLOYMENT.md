# Open Weather 앱 배포 가이드 (DEPLOYMENT.md)

이 문서는 Open Weather 앱을 구글 플레이 스토어 및 기타 플랫폼에 배포하기 위한 절차를 설명합니다.
...
- **앱 이름:** Open Weather
- **간단한 설명:** 당신의 하루를 가볍게, 미니멀 날씨 앱
- **자세한 설명:** 복잡한 정보는 걷어내고 현재 위치 및 검색한 도시의 핵심 날씨 정보만 제공합니다.
...
### 2.2 배포 워크플로우 실행
- 현재: 태그(`v1.0.0`) 푸시 시 릴리즈 자동 생성.
- 향후: 릴리즈 완료 후 [Google Play Action](https://github.com/marketplace/actions/upload-to-google-play)을 추가하여 자동으로 '내부 테스트' 트랙에 업로드 가능.

---

## 3. 현재 배포 상태 (v1.0.0)

- **GitHub Release:** 완료 ([릴리즈 페이지 바로가기](https://github.com/jeiel85/open-weather/releases))
- **Brand Page:** 가동 중 ([소개 페이지 바로가기](https://jeiel85.github.io/open-weather/))
